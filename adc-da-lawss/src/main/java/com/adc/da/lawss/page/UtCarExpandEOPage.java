...
/**
 * <b>功能：</b>UT_CAR_EXPAND UtCarExpandEOPage<br>
 * <b>作者：</b>code generator<br>
 * <b>日期：</b> 2018-09-03 <br>
 * <b>版权所有：<b>版权归北京卡达克数据技术中心所有。<br>
 */
public class UtCarExpandEOPage extends BasePage {
    ...
    private String effectiveDateOperator = "=";
    private String configId;
    private String configIdOperator = "=";
    private String arcticModel;
    private String arcticModelOperator = "=";
    private String expandCode;
    private String expandCodeOperator = "=";
    private String id;
    ...
    public String getEffectiveDateOperator() {
        return this.effectiveDateOperator;
    }

    public void setEffectiveDateOperator(String effectiveDateOperator) {
        this.effectiveDateOperator = effectiveDateOperator;
    }
    ...
    public String getConfigIdOperator() {
        return this.configIdOperator;
    }

    public void setConfigIdOperator(String configIdOperator) {
        this.configIdOperator = configIdOperator;
    }
    ...
    public String getArcticModelOperator() {
        return this.arcticModelOperator;
    }

    public void setArcticModelOperator(String arcticModelOperator) {
        this.arcticModelOperator = arcticModelOperator;
    }
    ...
    public String getExpandCodeOperator() {
        return this.expandCodeOperator;
    }

    public void setExpandCodeOperator(String expandCodeOperator) {
        this.expandCodeOperator = expandCodeOperator;
    }
