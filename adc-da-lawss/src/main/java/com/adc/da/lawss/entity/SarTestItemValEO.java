...
/**
 * <b>功能：</b>SAR_TEST_ITEM_VAL SarTestItemValEOEntity<br>
 * <b>作者：</b>code generator<br>
 * <b>日期：</b> 2018-09-03 <br>
 * <b>版权所有：<b>版权归北京卡达克数据技术中心所有。<br>
 */
public class SarTestItemValEO extends BaseEntity {
    ...
    public static String fieldToColumn(String fieldName) {
        ...
        switch (fieldName) {
            ...
            case "testItemId": return "test_item_id";
            case "id": return "id";
            default: return null;
        }
    }
    ...
    public static String columnToField(String columnName) {
        ...
        switch (columnName) {
            ...
            case "test_item_id": return "testItemId";
            case "id": return "id";
            default: return null;
        }
    }
