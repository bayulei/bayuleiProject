...
/**
 * <b>功能：</b>SAR_TEST_ITEM_VAL SarTestItemValEOPage<br>
 * <b>作者：</b>code generator<br>
 * <b>日期：</b> 2018-09-03 <br>
 * <b>版权所有：<b>版权归北京卡达克数据技术中心所有。<br>
 */
public class SarTestItemValEOPage extends BasePage {
    ...
    private String propertyValueOperator = "=";
    private String propertyType;
    private String propertyTypeOperator = "=";
    private String testItemId;
    private String testItemIdOperator = "=";
    private String id;
    ...
    public String getPropertyValueOperator() {
        return this.propertyValueOperator;
    }

    public void setPropertyValueOperator(String propertyValueOperator) {
        this.propertyValueOperator = propertyValueOperator;
    }
    ...
    public String getPropertyTypeOperator() {
        return this.propertyTypeOperator;
    }

    public void setPropertyTypeOperator(String propertyTypeOperator) {
    ...
    public String getTestItemIdOperator() {
        return this.testItemIdOperator;
    }

    public void setTestItemIdOperator(String testItemIdOperator) {
        this.testItemIdOperator = testItemIdOperator;
    }
