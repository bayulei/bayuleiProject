...
public class SarSarAccessEOPage extends BasePage {
    ...
    public String getAccessContentOperator() {
        return this.accessContentOperator;
    }

    public void setAccessContentOperator(String accessContentOperator) {
        this.accessContentOperator = accessContentOperator;
    }
