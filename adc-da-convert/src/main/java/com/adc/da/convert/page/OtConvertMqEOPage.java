package com.adc.da.convert.page;

import com.adc.da.base.page.BasePage;

/**
 * <b>功能：</b>OT_CONVERT_MQ OtConvertMqEOPage<br>
 * <b>作者：</b>code generator<br>
 * <b>日期：</b> 2018-09-25 <br>
 * <b>版权所有：<b>版权归北京卡达克数据技术中心所有。<br>
 */
public class OtConvertMqEOPage extends BasePage {
    ...
    private String mqStateOperator = "=";
    private String mqCode;
    private String mqCodeOperator = "=";
    private String id;
    ...
    public String getMqStateOperator() {
        return this.mqStateOperator;
    }

    public void setMqStateOperator(String mqStateOperator) {
        this.mqStateOperator = mqStateOperator;
    }
    ...
    public String getMqCodeOperator() {
        return this.mqCodeOperator;
    }

    public void setMqCodeOperator(String mqCodeOperator) {
        this.mqCodeOperator = mqCodeOperator;
    }
