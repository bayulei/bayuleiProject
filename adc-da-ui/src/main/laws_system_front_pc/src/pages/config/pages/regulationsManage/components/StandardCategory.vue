      ...
      <table-tools-bar>
        ...
        <div slot="right">
          ...
          <Drawer
            ...
            :styles="styles"
          >
            <Form :model="categoryModelAdd" ref="categoryModelAdd" :rules="categoryRules"  class="label-input-form" >
              <input v-model="categoryModelAdd.id" v-show="false">
              <Row>
                <Col span="12">
                  <FormItem label="选项" prop="dicTypeName"  label-position="top" class="standards-info-item">
                    <Input v-model="categoryModelAdd.dicTypeName" :disabled='modalType === 3'></Input>
                  </FormItem>
                </Col>
                <Col span="12">
                  <FormItem label="数据编码" prop="dicTypeCode" label-position="top" class="standards-info-item">
                    <Input v-model="categoryModelAdd.dicTypeCode" :disabled='modalType === 3'></Input>
                  </FormItem>
                </Col>
              </Row>
              <Row>
                <Col span="12">
                  <FormItem label="创建日期" prop="creationDate"  label-position="top" class="standards-info-item">
                    <Input v-model="categoryModelAdd.creationDate" :disabled='modalType === 3'></Input>
                  </FormItem>
                </Col>
                <Col span="12">
                  <FormItem label="创建人" prop="founder"  label-position="top" class="standards-info-item">
                    <Input v-model="categoryModelAdd.founder" :disabled='modalType === 3'></Input>
                  </FormItem>
                </Col>
              </Row>
            </Form>
...
<script src="./js/StandardCategory.js"></script>
<style lang="less">
  .standard-category {}
</style>
